...
public class CommonConstants {
    ...
    public static final String TRAFFIC_WEEKLY_NODE2 ="traffic_weekly_node2";
    ...
    public static final String TRAFFIC_MONTHLY_NODE2 ="traffic_monthly_node2";
    ...
    public static final String HOTLINE_SUMMARY_REMARK_TPL = " {1}，本{2}服务热线共接听电话总量{3}件，温州轨道APP回复{4}件。热线业务基本为咨询及求助，分别占比{5}及{6}。其中投诉{7}件，占接听总量的{8}，通过热线接到表扬{9}件，通过车站接到表扬{10}件，锦旗{11}面，占比{12}。S1线转接业务{13}件";
